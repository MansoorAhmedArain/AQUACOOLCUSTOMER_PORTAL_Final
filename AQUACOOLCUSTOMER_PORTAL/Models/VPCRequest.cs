...
namespace AQUACOOLCUSTOMER_PORTAL.Models
{
    public class VPCRequest
    {
        ...
        public VPCRequest(IConfiguration _config)
        {
            _address = new Uri(_config["AppSettings:PaymentServerURL"]);
            _merchantID = _config["AppSettings:vpc_Merchant"];
            _accessCode = _config["AppSettings:vpc_AccessCode"];
            _vpcCommand = _config["AppSettings:vpc_Command"]; 
            _vpcVersion = _config["AppSettings:vpc_Version"]; 
            _returnURL = _config["AppSettings:vpc_ReturnURL"];
            _secureSecret = _config["AppSettings:SecureSecret"];
        }
        ...
        public bool Process3PartyResponse(NameValueCollection nameValueCollection)
        {
